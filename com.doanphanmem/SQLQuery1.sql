...
AS
	...
	(hoTenNguoiNhan,NgayTaoDon,DiaChiGH,tinhThanh,quanHuyen, phuongXa,SdtNguoiNhan,MaGoiCuoc,khoiLuong,tenSP,soLuong,TenTKKH,TrangThaiDonHang,loaiGoiCuoc,hinhAnh)
	VALUES(
	@tenNguoiNhan,FORMAT (getdate(), 'MM-dd-yyyy'),@diaChiGiaoHang,@tinhThanh,@quanHuyen,@phuongXa,@sdtNguoiNhan,@dichVu,@khoiLuong,@tenSP,@soLuong,@tenTKKH,N'Chờ xử lý',@loaiGoiCuoc,@hinhAnh)
	END TRY
	BEGIN CATCH
	PRINT N'Lỗi';
	THROW
