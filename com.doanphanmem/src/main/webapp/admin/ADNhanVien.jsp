    ...
    <div class="content">
        <div class="container">
        	...
        	<c:if test="${sessionScope.acc.maQuyen == 1 }">     		
        		...
        		<div class="users">
		             <a href="nhanVien"> <div class="users-button" style="background: #2ecc71;color: white;border-radius: 10px">Nhân Viên</div></a>
            ...
            <table class="table table-striped" >
                <thead>
                  <tr style="background: #27AE60">
                    <th scope="col" style="color: white;">ID Nhân Viên</th>
                ...
                <tbody>
                <c:if test="${sessionScope.acc.maQuyen == 1 }"> 
                	<c:forEach items="${listAllNhanVien}" var="o">
                	<tr>
	                    <td>${o.tenDN }</td>
	                    <td>${o.hoTen}</td>
	                    <td>${o.ngaySinh}</td>
