...
<head>
    <meta charset="utf-8">
    <title>Công ty TNHH vận chuyển hàng hoá Vận Đạt</title>
...
<body>
    ...
    <!-- Header Start -->
    <div class="jumbotron jumbotron-fluid mb-5" style="margin-top: 120px;background-image: url('https://thacobinhduong.com/Content/UserFiles/BANNER_TRANGCHU_THACOTAI_TF85L.jpg');">
        <div class="container text-center py-5">
            <h1 class="text-primary mb-4">CÔNG TY TNHH VẬN CHUYỂN HÀNG HOÁ</h1>
            <h1 class=" display-3 mb-5" style="color: #c0392b; font-weight: 700;">VẬN ĐẠT</h1>
            <div class="mx-auto" style="width: 100%; max-width: 600px;">
                <div class="input-group">
                    <input type="text" class="form-control border-light" style="padding: 30px;" placeholder="Nhập tìm kiếm">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="d-flex align-items-center pt-2">
                        <button type="button" class="btn-play" data-toggle="modal"
                            data-src="https://youtu.be/OUYo-xQrtKg" data-target="#videoModal">
                            <span></span>
                        </button>
    ...
    <!--  Quote Request Start -->
    <div class="container-fluid my-5" style="background: #f8f4f4;">
        <div class="container">
            <div class="row align-items-center" ">
                <div class="col-lg-7 py-5 py-lg-0">
                    <h6 class="text-primary text-uppercase font-weight-bold" style="color: color: #27ae60;">Get A Quote</h6>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 mb-5" style="background: #f8f4f4; border-radius: 10px;box-shadow: -webkit-box-shadow: 5px 5px 15px 5px #696969; box-shadow: 5px 5px 15px 5px #696969;">
                    <div class="box-sd bg-sd">
                ...
                <div class="col-md-4 mb-5">
                    <div class="" style="background: #f8f4f4; border-radius: 10px;box-shadow: -webkit-box-shadow: 5px 5px 15px 5px #696969; box-shadow: 5px 5px 15px 5px #696969;">
                        <div class="text-center p-4">
                            <h1 class="display-4 mb-0">
