                ...
                <ul>
                    ...
                    <c:if test="${sessionScope.acc.maQuyen == 3 }">
                    	...
                    	<a href="quanli" >
	                     ...
	                     <a href="dhNhanVien?maNV=${sessionScope.acc.tenDN }">
                        	<li>DƠN HÀNG CỦA TÔI</li>
                    	</a>	
	                    <a href="thongke">
	                        <li>THỐNG KÊ</li>
	                    </a>
                    ...
                    <a href="profile?tenTKKH=${sessionScope.acc.tenDN }">
                    <div class="avatar-user">
                    	<img alt="" src="https://vapa.vn/wp-content/uploads/2022/12/anh-3d-thien-nhien.jpeg" style="width: 100%; height: 100%; object-fit:cover; border-radius: 50%">
                    </div>
                    </a>
                </ul>
            </div> 
